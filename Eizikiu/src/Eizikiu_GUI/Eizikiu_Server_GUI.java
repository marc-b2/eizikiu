...
//@Marc: Um die Dialogfenster zu erstellen braucht man nur die Methode JOptionPane.showMessageDialog(Component c (das Fenster in dem sich die Nachricht �ffnen soll),
...
//Steuerungsblock f�r alle Buttons und MenuItems
	@Override
	...
	// ItemState �berpr�fung die die jeweiligen Checker bedient (und die Logs mitschreibt oder eben nicht)
	@Override
	...
	public DefaultListModel<Room> actualizeRoomList(){
		...
		try {
			...
			this.writeLogger("Es sind keine R�ume vorhanden" + "\n");
			return rList;
		}
	}
